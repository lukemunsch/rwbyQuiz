...
In the beginnging of the JavaScript section of my project I created numerous versions of my code but I couldn't make the code compelete what I wanted it to. Through my research i have managed to find an example of quiz site that i have copied the structure it help build my site and I have adapted the code to make it my own and evolved it for my own quiz. The main video I used was James Q Quick's video on youtube, https://www.youtube.com/watch?v=zZdQGs62cR8 is the video for fixing the issues I had with my quiz code.
